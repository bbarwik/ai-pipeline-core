...
from ai_pipeline_core.debug import ContentWriter, TraceDebugConfig
...
class TestLLMMessageWriting:
    ...
    def test_write_multimodal_messages_with_image(
        self, writer: ContentWriter, tmp_path: Path
    ) -> None:
...
class TestDocumentListWriting:
    """Tests for DocumentList content extraction."""
