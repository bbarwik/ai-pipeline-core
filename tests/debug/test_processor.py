...
from ai_pipeline_core.debug import LocalDebugSpanProcessor, LocalTraceWriter, TraceDebugConfig
...
class TestLocalDebugSpanProcessor:
    ...
    def test_on_start_calls_writer(
        self, processor: LocalDebugSpanProcessor, writer: LocalTraceWriter
    ) -> None:
    ...
    def test_on_end_queues_job(
        ...
        with patch("ai_pipeline_core.debug.processor.StatusCode") as mock_status:
    ...
    def test_shutdown_calls_writer_shutdown(
        self, processor: LocalDebugSpanProcessor, writer: LocalTraceWriter
    ) -> None:
