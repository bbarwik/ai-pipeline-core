"""Prefect test fixtures for deployment tests.

Deployment tests use @pipeline_flow and @pipeline_task which require
...
def prefect_test_fixture():
    """Session-scoped Prefect ephemeral database for deployment tests."""
