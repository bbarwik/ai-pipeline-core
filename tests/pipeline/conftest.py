"""Prefect test fixtures for pipeline tests.

Pipeline tests use @pipeline_flow and @pipeline_task which require
...
def prefect_test_fixture():
    """Session-scoped Prefect ephemeral database for pipeline tests."""
