...
class TestPrepareImagesForModel:
    ...
    def test_small_image_passes_through(self):
        ...
        doc = ConcreteDocument(name="small.png", content=small_png)
        msgs = AIMessages([doc])
    ...
    def test_large_image_gets_split_default(self):
        ...
        doc = ConcreteDocument(name="tall.png", content=large_png)
        msgs = AIMessages([doc])
        ...
        assert len(result) > 1
        for tile in result:
            assert isinstance(tile, Document)
    ...
    def test_large_image_fits_gemini_not_default(self):
        ...
        doc = ConcreteDocument(name="medium.png", content=img_bytes)
        msgs = AIMessages([doc])
    ...
    def test_gemini_at_exact_3000x3000_not_split(self):
        ...
        doc = ConcreteDocument(name="exact.png", content=exact_png)
        msgs = AIMessages([doc])
    ...
    def test_gemini_one_pixel_over_3000_gets_reprocessed(self):
        ...
        doc = ConcreteDocument(name="over.png", content=over_png)
        msgs = AIMessages([doc])
    ...
    def test_gemini_splits_tall_image(self):
        ...
        doc = ConcreteDocument(name="huge.png", content=huge_png)
        msgs = AIMessages([doc])
    ...
    def test_mixed_content_preserved(self):
        ...
        large_png = _make_image(1000, 3000)
        small_doc = ConcreteDocument(name="small.png", content=small_png)
        large_doc = ConcreteDocument(name="large.png", content=large_png)
        text_doc = ConcreteDocument(name="readme.md", content=b"# Hello")
        ...
        for i in range(2, 2 + tile_count):
            assert isinstance(result[i], Document)
    ...
    def test_frozen_messages_not_mutated(self):
        ...
        large_png = _make_image(1000, 3000)
        doc = ConcreteDocument(name="big.png", content=large_png)
    ...
    def test_non_image_document_passes_through(self):
        ...
        pdf_doc = ConcreteDocument(name="doc.pdf", content=pdf_content)
        text_doc = ConcreteDocument(name="notes.txt", content=b"some text")
    ...
    def test_gif_large_image_gets_split(self):
        ...
        doc = ConcreteDocument(name="anim.gif", content=gif_bytes)
        msgs = AIMessages([doc])
    ...
    def test_small_gif_passes_through(self):
        ...
        doc = ConcreteDocument(name="small.gif", content=gif_bytes)
        msgs = AIMessages([doc])
    ...
    def test_tile_names_preserve_original_name(self):
        ...
        large_png = _make_image(1000, 3000)
        doc = ConcreteDocument(name="screenshot.png", content=large_png)
        msgs = AIMessages([doc])
    ...
    def test_corrupt_image_passes_through(self):
        ...
        doc = ConcreteDocument(name="corrupt.png", content=b"not a real image")
    ...
    def test_multiple_large_images_all_split(self):
        ...
        doc_a = ConcreteDocument(name="page_a.png", content=img_a)
        doc_b = ConcreteDocument(name="page_b.png", content=img_b)
        ...
        # All tiles are ImageDocument instances
        for tile in result:
            assert isinstance(tile, Document)
    ...
    def test_rgba_png_gets_split(self):
        ...
        doc = ConcreteDocument(name="transparent.png", content=rgba_bytes)
        msgs = AIMessages([doc])
