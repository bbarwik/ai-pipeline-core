...
# ai-pipeline-core v0.19.2 — API Reference
...
```python
async def llm_test_context(*, output_dir: Path | None=None, run_id: str='llm-test', generate_artifacts: bool=False) -> AsyncGenerator[DebugSession]: ...
